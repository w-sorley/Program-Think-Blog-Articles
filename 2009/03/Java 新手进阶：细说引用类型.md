...
-----
 ...
 在前几天的帖子《[Java性能优化[1]：基本类型 vs 引用类型](https://program-think.blogspot.com/2009/03/java-performance-tuning-1-two-types.html)》里，俺大概介绍了“引用类型”与“基本类型”在存储上的区别。昨天有网友在评论中批评说“引用类型变量和它所引用的对象”没区分清楚，容易混淆。所以今天专门来说一下引用类型的相关细节。program-think  
...
--------------
 ...
 ![不见图 请翻墙](images/IipVIIuED4vXXlv6ydLEDujhVx_B9UAhTCcSsZq-88Pdap0UuErhz5qUg6ussV6u0CLtIX9MY9aqRxp4PrUDfPkLlh7deFS0BZMd39L3oMFBMRK85-HgYcggO7AkcWQDl4sRDvqU)  
